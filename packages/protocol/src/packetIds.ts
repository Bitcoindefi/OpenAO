/**
 * Client packet IDs (server → client messages).
 *
 * These numeric identifiers are read by the client when parsing
...
/**
 * Server packet IDs (client → server messages).
 *
 * These numeric identifiers are written by the client when sending
