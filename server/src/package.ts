...
// Import shared packet IDs from @openao/protocol (single source of truth)
import { CLIENT_PACKET_ID, SERVER_PACKET_ID } from "@openao/protocol";
import type { ClientPacketID, ServerPacketID } from "@openao/protocol";

type PacketChunk = Buffer | ArrayBuffer | ArrayBufferView | string;

export type { ClientPacketID, ServerPacketID };
