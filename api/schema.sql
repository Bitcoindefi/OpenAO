...
-- Canonical map snapshots.
--
-- One JSONB document per map instead of 2.9 million tile rows. The source
-- files stay untouched and remain a fallback while the import is partial.
